...
namespace COMP003A.LectureActivity3_2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int num;
            Console.Write("Enter a posittive integer to generate its multiplication table: ");
            ...
            // loo[ through each fruit in the array
